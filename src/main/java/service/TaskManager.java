        ...
        while (session) {
            System.out.print(
                    """
                            ...
                            5 удалить задачу
                            6 сохранить в файл
                            7 сортировать по приоритету и распечатать задачи
                            8 сортировать по дате создания и распечатать задачи
                            9 сортировать по длине описания и распечатать задачи
                            """
            );
